...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">This category Products</span></h2>
        </div>
            ...
            foreach ($data['CatParentProductData'] as $item) {
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                    <div class="card product-item border-0 mb-4">
                        <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                           <a href="<?php route('accountController/detail')?>/<?php echo $item ->product_id;?>">
                           <img  class="img-fluid w-100" src="../../../eCommerceAdmin/public/assets/upload/<?php echo $item->image;?>"  alt="">

                       </a>
                       <!-- <input type="" name="" value="<?php echo $item->image;?>"> -->
                   </div>
                ...
                <div class="card-footer d-flex justify-content-center bg-light border">
                    <button class="btn btn-sm text-dark p-0" data-toggle='modal'><a class="fas fa-eye text-primary mr-1"
                        href="<?php route('accountController/detail')?>/<?php echo $item ->product_id;?>">View Detail</a></button>
                    </div>
                </form>
            </div>
        </div>
