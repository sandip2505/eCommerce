...
<div class="container-fluid pt-5">
    ...
    <div class="col-lg-4">
        <form class="mb-5" method="POST" action="<?php route('accountController/checkout')?>">
        ...
        <div class="card border-secondary mb-5">
            ...
            <div class="card-footer border-secondary bg-transparent">
                ...
                <button  class="btn btn-block btn-primary my-3 py-3"><a href="<?php route('orderController/checkout')?>">Proceed To Checkout</a></button>
            </div>
        </div>
    </div>
</div>
