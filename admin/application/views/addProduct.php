    ...
    <section class="content-header">
      ...
      <!-- <div class="col-md-12"> -->
        ...
        <!-- <div class="card-header"> -->
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form name="form1" method="post" id="form" action="<?php route('ProductController/createAccount')?>" enctype="multipart/form-data"><br>
           <div class="card-body">
             <div class="row">
              <!--   <div class="row"> -->
               <div class="col-12">
                <label for="Name">Name</label>
                <input type="text" class="form-control"  name="name" id="name" placeholder="Enter Product Name" ><br>  
                <span class="error"><?php if(!empty($data['nameError'])): echo $data['nameError']; endif; ?></span>  
              </div>
              <div class="col-6">
                <label for="Price">Price</label>
                <input type="number" class="form-control"  name="price" id="price" placeholder="Enter Product Price" ><br>
                <span class="error"><?php if(!empty($data['priceError'])): echo $data['priceError']; endif; ?></span>  
              </div>               
              <div class="col-6">
                <label for="RRP">RRP</label>
                <input type="text" class="form-control"  name="rrp" id="rrp" placeholder="Enter RRP"><br>
                 <span class="error"><?php if(!empty($data['rrpError'])): echo $data['rrpError']; endif; ?></span>  
              </div>
               
              <div class="col-6">
                <label for="SKU">SKU Code</label>
                <input type="text" class="form-control"  name="sku" id="sku" placeholder="Enter Code"><br>  
              <span class="error"><?php if(!empty($data['skuError'])): echo $data['skuError']; endif; ?></span>
              </div>
              <div class="col-6">
                <label for="Quantity">Quantity</label>
                <input type="number" class="form-control form-control" id="qty"  name="qty" placeholder="Quantity"><br>
